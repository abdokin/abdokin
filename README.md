...
I'm a software engineer who builds reliable products end-to-end — from UI to APIs to CI/CD. I like clean architecture, pragmatic decisions, and measurable performance wins. 🧠⚙️

- 🔭 Building production features & internal tools
- 🌱 Learning continuously (backend performance, infra, and DX)
- 💡 Turning ideas into shippable code
- 🤝 Open to collaborations (OSS + product work)
- ⚡ Fun fact: I believe clean code is happy code

---

## 🧩 Quick Facts

- **Focus:** Product engineering, backend reliability, dev tooling  
- **Strengths:** API design, performance, testing, automation  
- **Currently using:** Ruby on Rails, TypeScript, React, Go, Docker
...
- ✅ Built/maintained production APIs with **Rails / Node / Go**
- ⚡ Improved performance through query/index tuning + caching
...
![Contribution Graph](https://github-readme-activity-graph.vercel.app/graph?username=abdokin&theme=high-contrast&hide_border=true&custom_title=Contribution%20Graph)
...
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)]([https://linkedin.com/in/abdokin](https://www.linkedin.com/in/abderrahman-laraich/))
